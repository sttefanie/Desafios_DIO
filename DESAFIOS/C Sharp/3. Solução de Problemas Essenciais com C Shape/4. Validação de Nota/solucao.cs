 ...
 * pediu para que você desenvolva um programa que calcule e imprima a média semestral. Faça com 
 * que o algoritmo só aceite notas válidas (uma nota válida deve pertencer ao intervalo [0,10]). 
 ...
 *      Quando duas notas válidas forem lidas, deve ser impressa a mensagem "media = " seguido do 
 * valor do cálculo. O valor deve ser apresentado com duas casas após o ponto decimal.
 *
 **********************************************************************************************/
